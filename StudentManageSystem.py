...
global studentlist
studentlist = ["Mukul Lokhande", "Pranav Bobade", "Omprakash Rathod", "Suraj Chavan", "Naresh Khake", "Siddharth Rathod", "Ganesh wattamnar", "Pushpak Ghatode", "Rahul Patil", "Pratiksha Patil", "Sonakshi Agrawal", "Sandhya Mehta"]
